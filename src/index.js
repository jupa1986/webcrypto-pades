...
export {listCertificates, listProviders, keyFromCertificateId, certificateRaw, createCMSSigned, signpdf, setEngine, issuerCertificate, listSignatures, firstCertificate, firstProvider};
